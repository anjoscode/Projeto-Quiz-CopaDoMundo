...
export default function Pergunta2() {
  // Captura os parâmetros enviados pela tela anterior (Pergunta 1)
  ...
  const responder = (acertou: boolean) => {
    ...
    // router.push({ pathname: '/pergunta3', params: { acertos: pontosAtuais } });
    // ========================================

    // Lógica funcional: calcula os novos pontos e envia para a Pergunta 3
    let pontosAtuais = pontosRecebidos;
    if (acertou) { 
      pontosAtuais = pontosRecebidos + 1; 
    }
    
    // CORREÇÃO AQUI: Mudado de '/pergunta2' para '/pergunta3'
    router.push({ 
      pathname: '/pergunta3' as any, 
