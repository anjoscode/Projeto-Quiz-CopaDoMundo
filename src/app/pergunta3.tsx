...
export default function Pergunta3() {
  // Captura os parâmetros enviados pela tela anterior (Pergunta 2)
  ...
  const responder = (acertou: boolean) => {
    ...
    // router.push({ pathname: '/pergunta4', params: { acertos: pontosAtuais } });
    // ========================================

    // Lógica funcional: calcula os novos pontos e envia para a Pergunta 4
